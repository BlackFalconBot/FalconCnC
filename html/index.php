...
//Application Title
define('APP_TITLE', 'AVIATO-Pi Vulnerability Assessment Reports ');
...
$auth_users = array(
    'admin' => '$2y$10$Z4Ixan6k5II2uioXOWe6ROw6whnQK6Oc0Pl2vN4fmA0Em5ABQCYq.', //admin@123
    'user' => '$2y$10$Z4Ixan6k5II2uioXOWe6ROw6whnQK6Oc0Pl2vN4fmA0Em5ABQCYq.' //12345
);
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> AVIATO-Pi Vulnerability Assessment Reports <?php echo VERSION; ?></a></h3></p>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">AVIATO-Pi Vulnerability Assessment Reports  <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">AVIATO-Pi Vulnerability Assessment Reports  <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'AVIATO-Pi Vulnerability Assessment Reports <br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
